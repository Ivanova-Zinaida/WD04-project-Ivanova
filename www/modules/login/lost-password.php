	...
	if(isset($_POST['lost-password'])){
		...
		if(empty($errors)){
			...
			if($user){
				...
				$recovery_message.="Для сброма пароля перейдите по ссылке ниже, и установите новый пароль:</p>";
