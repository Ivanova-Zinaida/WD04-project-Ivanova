		<div class="header-admin">
			<div class="user-info">
				...
				<div class="user-info__data user-content ml-15">
					...
					<a class="badge" href="<?=HOST?>profile">Администратор</a></div>
			</div>
	        <ul class="admin-nav section-ui">
				<li class="admin-nav-item"><a class="admin-nav__link" href="<?=HOST?>blog/post-naw"><i class="fas fa-plus-circle"></i><span class="ml-10">Пост</span></a></li>
