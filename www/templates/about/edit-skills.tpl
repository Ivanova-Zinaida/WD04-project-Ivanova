					...
					<form class="edit-tech" action="edit-skills"  method="POST">
						<div class="section-ui">
							...
							<?php function skillItem($name, $title){ global $skills;  ?>
								<div class="col-lg-2">
									<p class="edit-tech-text"><b><?=$title;?></b></p><input class="input edit-tech-input" name="<?=$name;?>" type="type" placeholder="0" value="<?=$skills[$name]?>"/><label class="edit-tech-label">%</label>
								</div>
							<?php }?>
						...
						<div class="section-ui">
							<div class="row">
								<div class="col-lg-1 mr-70"> <input name="skillsUpdate" type="submit" class="button button--save" value="Сохранить"></div>
								<div class="col-lg-2"><a class="button" href="<?=HOST?>about">Отмена</a></div>
							</div>
						</div>
					</form>
				</div>
